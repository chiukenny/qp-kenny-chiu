...
\title{Summary of work by \citeauthor{Mouli:2021} \parencite{Mouli:2021}\\\vspace{1em}and\\\vspace{1em}Invariance testing via kernel hypothesis tests\\\vspace{1em}\large{STAT 548 Qualifying Paper}} % replace with your title
