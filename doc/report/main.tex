...
\title{Summary of \citeauthor{Mouli:2021}'s work \parencite{Mouli:2021}\\\vspace{1em}and\\\vspace{1em}Testing for group invariance using kernel hypothesis tests\\\vspace{1em}\large{STAT 548 Qualifying Paper}} % replace with your title
